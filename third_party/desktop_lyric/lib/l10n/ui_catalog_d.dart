...
const Map<String, List<String>> uiCatalogD = {
  ...
  '个码率区间': ['bitrate ranges', 'ビットレート範囲', '비트레이트 구간'],
  '个时长区间': ['duration ranges', '再生時間範囲', '재생 시간 구간'],
  '种语言': ['languages', '言語', '언어'],
  '种格式': ['formats', '形式', '형식'],
  '种来源': ['sources', '音源', '소스'],
  ...
  '未知码率': ['Unknown bitrate', '不明なビットレート', '알 수 없는 비트레이트'],
  '未知时长': ['Unknown duration', '不明な再生時間', '알 수 없는 재생 시간'],
  '128 kbps 及以下': ['128 kbps or less', '128 kbps 以下', '128 kbps 이하'],
  '129–192 kbps': ['129–192 kbps', '129–192 kbps', '129–192 kbps'],
  '193–256 kbps': ['193–256 kbps', '193–256 kbps', '193–256 kbps'],
  '257–320 kbps': ['257–320 kbps', '257–320 kbps', '257–320 kbps'],
  '高于 320 kbps': ['Above 320 kbps', '320 kbps 超', '320 kbps 초과'],
  '少于 2 分钟': ['Under 2 minutes', '2 分未満', '2분 미만'],
  '2–4 分钟': ['2–4 minutes', '2–4 分', '2–4분'],
  '5–9 分钟': ['5–9 minutes', '5–9 分', '5–9분'],
  '10–29 分钟': ['10–29 minutes', '10–29 分', '10–29분'],
  '30 分钟及以上': ['30 minutes or more', '30 分以上', '30분 이상'],
  '中文': ['Chinese', '中国語', '중국어'],
  '英文': ['English', '英語', '영어'],
  '日文': ['Japanese', '日本語', '일본어'],
  '韩文': ['Korean', '韓国語', '한국어'],
