...
class TextDisplayController extends ChangeNotifier {
  ...
  Color specifiedColor =
      Color(DesktopLyricController.instance.theme.value.primary);
        ...
        child: Column(
          ...
          children: [
            AnimatedSwitcher(
              ...
              transitionBuilder: _foregroundTransition,
...
Widget _foregroundTransition(Widget child, Animation<double> animation) {
