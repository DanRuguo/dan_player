...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 100673091;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        16 => wire__crate__api__metadata_preflight__preflight_audio_metadata_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__utils__show_in_explorer_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__tag_reader__update_audio_metadata_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__tag_reader__update_index_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__tag_reader__create_index_scan_task_impl(ptr, rust_vec_len, data_len),
        17 => {
            wire__crate__api__tag_reader__release_index_scan_task_impl(ptr, rust_vec_len, data_len)
        }
        19 => wire__crate__api__system_theme__system_theme_get_system_theme_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
