...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<IndexActionState> crateApiTagReaderBuildIndexFromFoldersRecursively(
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      argValues: [folders, indexPath, taskId, sink],
      apiImpl: this,
    )));
    return sink.stream;
  }
  ...
  TaskConstMeta
      get kCrateApiTagReaderBuildIndexFromFoldersRecursivelyConstMeta =>
          const TaskConstMeta(
            ...
            argNames: ["folders", "indexPath", "taskId", "sink"],
          );
  ...
  String crateApiTagReaderCancelIndexScanTask({required String taskId}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTagReaderCancelIndexScanTaskConstMeta,
      argValues: [taskId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderCancelIndexScanTaskConstMeta =>
      const TaskConstMeta(
        debugName: "cancel_index_scan_task",
        argNames: ["taskId"],
      );
  ...
  String crateApiTagReaderCreateIndexScanTask() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTagReaderCreateIndexScanTaskConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderCreateIndexScanTaskConstMeta =>
      const TaskConstMeta(
        debugName: "create_index_scan_task",
        argNames: [],
      );
  ...
  Future<String> crateApiMetadataPreflightPreflightAudioMetadata(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMetadataPreflightPreflightAudioMetadataConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMetadataPreflightPreflightAudioMetadataConstMeta =>
      const TaskConstMeta(
        debugName: "preflight_audio_metadata",
        argNames: ["path"],
      );
  ...
  void crateApiTagReaderReleaseIndexScanTask({required String taskId}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiTagReaderReleaseIndexScanTaskConstMeta,
      argValues: [taskId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTagReaderReleaseIndexScanTaskConstMeta =>
      const TaskConstMeta(
        debugName: "release_index_scan_task",
        argNames: ["taskId"],
      );
  ...
  Future<String> crateApiTagReaderUpdateAudioMetadata(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiTagReaderUpdateAudioMetadataConstMeta,
      argValues: [
        path,
        fileName,
        title,
  ...
  TaskConstMeta get kCrateApiTagReaderUpdateAudioMetadataConstMeta =>
      const TaskConstMeta(
        debugName: "update_audio_metadata",
        argNames: [
          "path",
          "fileName",
          "title",
  ...
  Stream<IndexActionState> crateApiTagReaderUpdateIndex(
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      argValues: [indexPath, taskId, sink],
      apiImpl: this,
    )));
    return sink.stream;
  }
  ...
  TaskConstMeta get kCrateApiTagReaderUpdateIndexConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["indexPath", "taskId", "sink"],
      );
