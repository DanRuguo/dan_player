...
// These functions are ignored because they are not marked as `pub`: `_get_lyric_from_lofty`, `_get_lyric_from_lrc_file`, `_get_picture_by_lofty`, `_get_picture_by_windows`, `apply_tag_values`, `artist_from_tags_with_source`, `capture`, `check_metadata_fingerprint`, `copy_of`, `cover_decode_dimensions`, `disarm`, `edited_cover`, `ensure_tag`, `first_tag_text_with_source`, `has_indexed_title`, `is_edited_metadata_key`, `is_metadata_transaction_path`, `is_supported_audio_path`, `metadata_error`, `metadata_io_error`, `metadata_is_missing`, `metadata_message`, `move_file_without_replacing`, `multiset_contains`, `multithreaded`, `needs_classification_backfill`, `needs_duration_backfill`, `new_with_path`, `normalize_decoded_id3_flags`, `ordered_tags`, `panic_payload_to_string`, `path`, `preserve_legacy_language_frames`, `probe_tagged_audio`, `read_by_lofty`, `read_by_win_music_properties`, `read_explicit_path`, `read_from_path`, `read_index_json`, `read_tagged_file_by_content`, `replace_with_rollback`, `reserve_transaction_path`, `resize_picture`, `same_existing_file`, `sanitize_file_name`, `save_edited_primary_tag`, `sibling_path`, `text_from_tag`, `text_looks_misdecoded`, `to_json_value`, `unused_transaction_path`, `verify_metadata_edit`, `verify`, `write_index_json`, `write_metadata_with_expectation`
