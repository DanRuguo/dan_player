  ...
  for (final size in [const Size(1000, 800), const Size(507, 320)]) {
    for (final scale in [1.0, 2.0]) {
      testWidgets(
        ...
        final beforeControls = tester.getRect(controls);
        final beforeResults = tester.getRect(results);
        ...
        await tester.pumpAndSettle();
        expect(tester.widget<ListView>(results).controller!.offset,
            greaterThan(0));
        expect(controlPosition.pixels, beforePixels,
