# Dan Player：一款使用 Material You 配色的本地音乐播放器。
![音乐页](软件截图/音乐页.png)
...
## 安装
1. 下载 [Release](https://github.com/DanRuguo/dan_player/releases/latest) 里文件安装
2. 如需反馈问题，请到 [Issues](https://github.com/DanRuguo/dan_player/issues) 创建问题。
3. 如果后续维护 scoop 安装源，可在这里补充 bucket 信息。
```sh
# 安装
scoop install dan_player
```
...
## 编译
1. 开发 flutter 需要的环境
2. 需要编译 Dan Player（本仓库） 软件本体和 desktop_lyric。[desktop_lyric](https://github.com/Ferry-200/desktop_lyric.git) 也是 Flutter 应用，直接编译即可
