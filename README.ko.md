...
| 버전 | 용도 | 다운로드 |
| --- | --- | --- |
| **26.0.6 snapshot1 · 미리 보기** | 가사 편집과 재생 조작 개선 사항 체험 | [설치 프로그램, 포터블 ZIP 및 체크섬](https://github.com/DanRuguo/dan_player/releases/tag/v26.0.6-snapshot.1) |
| **26.0.5 · 안정 버전** | 일상적인 음악 감상에 사용할 정식 릴리스 | [설치 프로그램, 포터블 ZIP 및 체크섬](https://github.com/DanRuguo/dan_player/releases/tag/v26.0.5) |
...
가사 미리 듣기와 자르기에 필요한 FFmpeg는 선택 사항입니다. 직접 다운로드할 때 [26.0.5에 공개한 별도 구성 요소 패키지](https://github.com/DanRuguo/dan_player/releases/tag/v26.0.5)를 재사용하고 고정된 크기와 SHA-256을 검증합니다. 26.0.6 snapshot1 설치 프로그램과 포터블 ZIP에는 중복해서 포함하지 않습니다.
