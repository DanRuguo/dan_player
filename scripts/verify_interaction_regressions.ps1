...
$regressionTests = @(
    'test/category_tile_layout_test.dart',
    'test/item_menu_lifecycle_test.dart',
    'test/ui_2605_regression_test.dart',
    ...
    'test/statistics_distribution_comparison_test.dart',
    'test/playback_statistics_test.dart',
    'test/lyric_service_lifecycle_test.dart',
    'test/issue_page_layout_test.dart',
    'test/detail_diagnostics_layout_test.dart',
    ...
    'test/lyric_editor_dialog_test.dart',
    'test/theme_mode_preference_test.dart',
    'test/theme_provider_test.dart',
    'test/artwork_handoff_test.dart',
    'test/artwork_backdrop_test.dart',
    'test/artwork_pipeline_test.dart',
    'test/theme_picker_polish_test.dart',
    'test/title_bar_window_state_test.dart',
    'test/desktop_window_corners_test.dart',
    'test/audio_metadata_update_test.dart',
    'test/batch_audio_metadata_test.dart',
    'test/batch_metadata_cover_ui_test.dart',
    'test/playback_bookmarks_test.dart',
    'test/playback_bookmarks_dialog_test.dart',
    ...
    'test/app_scrollbar_idle_test.dart',
    'test/app_content_transition_test.dart',
    'test/multi_selection_motion_test.dart',
    'test/grouped_settings_test.dart',
    'test/bookmark_library_live_updates_test.dart',
    ...
    'test/desktop_lyric_theme_transition_test.dart',
